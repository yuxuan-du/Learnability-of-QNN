...
r'''From here we define a class of elementary quantum gates '''
...
def feature_encoding(feature_, n_qubit =3):
    ...
    U_layer2 = np.kron(CRY2_, I()) @ np.kron(I(), CRY2_)
...
class PQC_classifier():
    ...
    def target_unitary(self, para_):
        r'''
        :param para_: the variation parameters to be updated
        The target unitary applies to the input vector.
        '''
    ...
    def compute_predict_vector(self, input_state_, para_):
